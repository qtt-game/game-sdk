...
function queryOrder(appkey, app_id, open_id, trade_no) {
    var url = "https://newidea4-gamecenter-backend.1sapp.com/x/pay/union/order/query";
    var time = Math.floor(Date.now() / 1000);
...
_axios2.default.defaults.timeout = 2000;

var get = exports.get = function get(url, opts) {
    return _axios2.default.get(url, opts);
};
